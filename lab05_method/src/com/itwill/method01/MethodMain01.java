...
public class MethodMain01 {
	...
	public static void main(String[] args) {
		...
		// -> println 메서드를 호출
		// -> println을 호출할 때 전달한 값을 argument
		// -> println 메서드에서 argument를 저장하기 위해서 선언한 변수 -> parameter
		// -> println은 반환값이 없는 메서드
		
		Random rand = new Random();
		
		int x = rand.nextInt(10);
		// -> nextInt 메서드를 호출. argument 10을 전달
