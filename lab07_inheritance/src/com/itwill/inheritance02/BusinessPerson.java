...
public class BusinessPerson extends Person{
	 ...
	 * super(); 호출은 생략 가능
	 * 하위 클래스의 생성자에서 상위 클래스의 생성자를 명시적으로 호출할 때는 super 키워드를 사용
	 * 상위 클래스의 argument를 갖는 생성자는 자동으로 호출되지 않음
	 * 상위 클래스의 argument를 갖는 생성자를 호출하려면 반드시 super(...);를 호출해야만 함
