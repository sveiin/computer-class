...
/*
 * 인터페이스(interface)
 * 사용 목적: 팀/회사 간의 분업/협업을 하기 위한 메서드들의 signature를 약속하기 위해서
 * 인터페이스가 가질 수 있는 멤버:
...
//		MySqlDatabase db = new MySqlDatabase();
		...
		Database db = new MySqlDatabase(); // 다형성
