...
//import com.itwill.class03.Person;
//import com.itwill.modifier03.Person; // 클래스 이름이 같으면 import 불가
									   // 사용할 때마다 패키지 이름을 전부 작성하면 쓸 수는 있음
...
//		System.out.println(ex.b); // -> 컴파일 에러: not visible
		ex.info();
	}
